...
var runGame = function() {
	...
	function create() {
		...
		setInterval(launchAsteroid, 11000);
	...
	/*****************************
	callback functions to be used for overlap detection
	*******************************/
...
//run all the game code above after the opening credits are finished (50 seconds)
var timer1 = setTimeout(runGame, 47000);
//or if the skip button is clicked
$('#skip').click(function(){
	clearTimeout(timer1);
	runGame();
});
